...
| --------- | --------------- | ------------ | --------- |
| DC3_BORDER_LEAFS | Vlan4094 | 10.255.255.252 | Port-Channel551 |
...
!
mlag configuration
   domain-id DC3_BORDER_LEAFS
   local-interface Vlan4094
   peer-address 10.255.255.252
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | MLAG_PEER_DC3-BORDER1_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_DC3-BORDER1_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | L3 Uplink to WAN for CORP VRF | routed | - | 33.33.33.6/30 | CORP | - | False | - | - |
| Ethernet49/1 | P2P_LINK_TO_DC3-SPINE1_Ethernet8/1 | routed | - | 10.3.1.253/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC3-SPINE2_Ethernet8/1 | routed | - | 10.3.1.255/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel551 | MLAG_PEER_DC3-BORDER1_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.3.103.128/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.3.113.127/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.3.103.128/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.3.113.127/32
```
...
| Vlan3009 |  CORP  |  10.255.254.253/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.254.253/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.255.253/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.3.1.252 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.3.1.254 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.3.100.1 | 65003 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - |
...
| 10.255.254.252 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.255.254.252 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 33.33.33.5 | 22222 | CORP | - | Inherited from peer group WAN | Inherited from peer group WAN | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.3.103.128:10010 | 10010:10010 | - | - | learned |
| 40 | 10.3.103.128:10040 | 10040:10040 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.3.103.128:10 | connected |
...
router bgp 65316
   ...
   neighbor 10.3.1.252 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.3.1.252 remote-as 65003
   neighbor 10.3.1.252 description DC3-SPINE1_Ethernet8/1
   neighbor 10.3.1.254 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.3.1.254 remote-as 65003
   neighbor 10.3.1.254 description DC3-SPINE2_Ethernet8/1
   neighbor 10.3.100.1 peer group EVPN-OVERLAY-PEERS
   neighbor 10.3.100.1 remote-as 65003
   neighbor 10.3.100.1 description DC3-SPINE1
   neighbor 10.3.100.2 peer group EVPN-OVERLAY-PEERS
   neighbor 10.3.100.2 remote-as 65003
   neighbor 10.3.100.2 description DC3-SPINE2
   neighbor 10.255.254.252 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.254.252 description DC3-BORDER1
   ...
   vrf CORP
      ...
      router-id 10.3.103.128
      neighbor 10.255.254.252 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 33.33.33.5 remote-as 22222
      neighbor 33.33.33.5 peer group WAN
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.3.103.0/24 eq 32 |
| 20 | permit 10.3.113.0/24 eq 32 |
...
ip prefix-list PL-LOOPBACKS-EVPN-OVERLAY
   seq 10 permit 10.3.103.0/24 eq 32
   seq 20 permit 10.3.113.0/24 eq 32
```
