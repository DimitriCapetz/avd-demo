...
| --------- | --------------- | ------------ | --------- |
| DC3_BORDER_LEAVES | Vlan4094 | 10.255.255.252 | Port-Channel551 |
...
| Loopback10 | CORP_VTEP_DIAGNOSTICS | CORP | 10.255.10.128/32 |
...
| 90 | 10.3.103.128:10090 | 10090:10090 | - | - | learned |
...
```eos
!
ip address virtual source-nat vrf CORP address 10.255.10.128
```
