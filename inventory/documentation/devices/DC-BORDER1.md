...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.186/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC_BORDER_LEAVES | Vlan4094 | 10.1.0.253 | Port-Channel551 |
...
!
mlag configuration
   domain-id DC_BORDER_LEAVES
   local-interface Vlan4094
   peer-address 10.1.0.253
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | MLAG_PEER_DC-BORDER2_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_DC-BORDER2_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC-SPINE1_Ethernet7/1 | routed | - | 10.0.1.249/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC-SPINE2_Ethernet7/1 | routed | - | 10.0.1.251/31 | default | 1500 | False | - | - |
| Ethernet51/1.110 | L3 Uplink to WAN for Tenant_10_OP_Zone VRF | l3dot1q | - | 192.168.110.0/31 | Tenant_10_OP_Zone | - | False | - | - |
...
interface Ethernet49/1
   description P2P_LINK_TO_DC-SPINE1_Ethernet7/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.0.1.249/31
!
interface Ethernet50/1
   description P2P_LINK_TO_DC-SPINE2_Ethernet7/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.0.1.251/31
!
...
interface Ethernet51/1.110
   ...
   ip address 192.168.110.0/31
!
interface Ethernet55/1
   description MLAG_PEER_DC-BORDER2_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_DC-BORDER2_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel551 | MLAG_PEER_DC-BORDER2_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_DC-BORDER2_Po551
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.254.127/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.255.127/32 |
| Loopback10 | Tenant_10_OP_Zone_VTEP_DIAGNOSTICS | Tenant_10_OP_Zone | 10.255.10.127/32 |
| Loopback11 | Tenant_10_WEB_Zone_VTEP_DIAGNOSTICS | Tenant_10_WEB_Zone | 10.255.11.127/32 |
| Loopback20 | Tenant_20_OP_Zone_VTEP_DIAGNOSTICS | Tenant_20_OP_Zone | 10.255.20.127/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan18 |  Tenant_10_WEB_Zone  |  10.10.18.2/24  |  -  |  10.10.18.1  |  -  |  -  |  -  |
| Vlan19 |  Tenant_10_OP_Zone  |  10.10.19.2/24  |  -  |  10.10.19.1  |  -  |  -  |  -  |
| Vlan29 |  Tenant_20_OP_Zone  |  10.20.29.2/24  |  -  |  10.20.29.1  |  -  |  -  |  -  |
| Vlan3009 |  Tenant_10_OP_Zone  |  10.1.1.252/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Tenant_10_WEB_Zone  |  10.1.1.252/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Tenant_20_OP_Zone  |  10.1.1.252/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.1.1.252/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.1.0.252/31  |  -  |  -  |  -  |  -  |  -  |
...
| Tenant_10_OP_Zone | 0.0.0.0/0 | 192.168.110.1 | Ethernet51/1.110 | 1 | - | DEFAULT_TO_WAN | - |
...
ip route vrf Tenant_10_OP_Zone 0.0.0.0/0 Ethernet51/1.110 192.168.110.1 name DEFAULT_TO_WAN
```
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.0.1.248 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.0.1.250 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.1.1.253 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| 10.1.1.253 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_10_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.1.1.253 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_10_WEB_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.1.1.253 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_20_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 18 | 10.255.254.127:10018 | 10018:10018 | - | - | learned |
| 19 | 10.255.254.127:10019 | 10019:10019 | - | - | learned |
| 29 | 10.255.254.127:10029 | 10029:10029 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_10_OP_Zone | 10.255.254.127:10 | connected<br>static |
| Tenant_10_WEB_Zone | 10.255.254.127:11 | connected |
| Tenant_20_OP_Zone | 10.255.254.127:20 | connected |
...
router bgp 65199
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC-BORDER2
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.0.1.248 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.1.248 remote-as 65000
   neighbor 10.0.1.248 description DC-SPINE1_Ethernet7/1
   neighbor 10.0.1.250 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.1.250 remote-as 65000
   neighbor 10.0.1.250 description DC-SPINE2_Ethernet7/1
   neighbor 10.1.1.253 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.1.1.253 description DC-BORDER2
   ...
   !
   vlan 18
      rd 10.255.254.127:10018
      route-target both 10018:10018
      redistribute learned
   !
   vlan 19
      rd 10.255.254.127:10019
      route-target both 10019:10019
      redistribute learned
   !
   vlan 29
      rd 10.255.254.127:10029
...
| -------------- | --------------------- |
| Tenant_10_OP_Zone | 10.255.10.127 |
| Tenant_10_WEB_Zone | 10.255.11.127 |
| Tenant_20_OP_Zone | 10.255.20.127 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_10_OP_Zone address 10.255.10.127
ip address virtual source-nat vrf Tenant_10_WEB_Zone address 10.255.11.127
ip address virtual source-nat vrf Tenant_20_OP_Zone address 10.255.20.127
```
