...
| --------- | --------------- | ------------ | --------- |
| ENT-DC1-BORDER-LEAVES | Vlan4094 | 10.255.255.61 | Port-Channel551 |
...
!
mlag configuration
   domain-id ENT-DC1-BORDER-LEAVES
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | MLAG_PEER_ENT-DC1-BORDER2_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC1-BORDER2_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
interface Ethernet55/1
   description MLAG_PEER_ENT-DC1-BORDER2_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_ENT-DC1-BORDER2_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel551 | MLAG_PEER_ENT-DC1-BORDER2_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_ENT-DC1-BORDER2_Po551
   no shutdown
   switchport
...
!
interface Vxlan1
   description ENT-DC1-BORDER1_VTEP
...
router bgp 65116
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ENT-DC1-BORDER2
   ...
   neighbor 10.255.251.61 description ENT-DC1-BORDER2
