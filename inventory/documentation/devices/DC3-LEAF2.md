...
| --------- | --------------- | ------------ | --------- |
| DC3_LEAF_DOMAIN_1 | Vlan4094 | 10.255.255.0 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC3-HOST1_Et2 | *access | *10 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_DC3-LEAF1_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_DC3-LEAF1_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC3-SPINE1_Ethernet2/1 | routed | - | 10.3.0.5/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC3-SPINE2_Ethernet2/1 | routed | - | 10.3.0.7/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | DC3-HOST1_PortChannel101 | switched | access | 10 | - | - | - | - | 1 | - |
| Port-Channel551 | MLAG_PEER_DC3-LEAF1_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description DC3-HOST1_PortChannel101
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.3.103.2/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.3.0.4 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.3.0.6 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
| 10.255.254.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.3.103.2:10010 | 10010:10010 | - | - | learned |
| 40 | 10.3.103.2:10040 | 10040:10040 | - | - | learned |
| 90 | 10.3.103.2:10090 | 10090:10090 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.3.103.2:10 | connected |
...
router bgp 65301
   ...
   neighbor 10.3.0.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.3.0.4 remote-as 65003
   neighbor 10.3.0.4 description DC3-SPINE1_Ethernet2/1
   neighbor 10.3.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.3.0.6 remote-as 65003
   neighbor 10.3.0.6 description DC3-SPINE2_Ethernet2/1
   ...
   neighbor 10.255.254.0 description DC3-LEAF1
