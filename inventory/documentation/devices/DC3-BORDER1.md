...
| --------- | --------------- | ------------ | --------- |
| DC3_BORDER_LEAVES | Vlan4094 | 10.255.255.253 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | MLAG_PEER_DC3-BORDER2_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_DC3-BORDER2_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC3-SPINE1_Ethernet7/1 | routed | - | 10.3.1.249/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC3-SPINE2_Ethernet7/1 | routed | - | 10.3.1.251/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel551 | MLAG_PEER_DC3-BORDER2_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.3.103.127/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.3.113.127/32 |
| Loopback10 | CORP_VTEP_DIAGNOSTICS | CORP | 10.255.10.127/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.3.1.248 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.3.1.250 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
| 90 | 10.3.103.127:10090 | 10090:10090 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.3.103.127:10 | connected |
...
router bgp 65316
   ...
   neighbor 10.3.1.250 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.3.1.250 remote-as 65003
   neighbor 10.3.1.250 description DC3-SPINE2_Ethernet7/1
   ...
   neighbor 10.255.254.253 description DC3-BORDER2
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 10.3.103.127:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 40
      rd 10.3.103.127:10040
      route-target both 10040:10040
      redistribute learned
   !
   vlan 90
      rd 10.3.103.127:10090
...
```eos
!
ip address virtual source-nat vrf CORP address 10.255.10.127
```
