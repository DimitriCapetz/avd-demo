...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.187/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC_BORDER_LEAVES | Vlan4094 | 10.1.0.252 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | MLAG_PEER_DC-BORDER1_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_DC-BORDER1_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
interface Ethernet49/1
   description P2P_LINK_TO_DC-SPINE1_Ethernet8/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_DC-SPINE2_Ethernet8/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet56/1
   description MLAG_PEER_DC-BORDER1_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel551 | MLAG_PEER_DC-BORDER1_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_DC-BORDER1_Po551
   no shutdown
   switchport
