...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.43/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF_DOMAIN_1 | Vlan4094 | 10.255.255.1 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | ENT-DC1-HOST1_Et1 | *trunk | *10,20,110,111 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_ENT-DC1-LEAF2_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC1-LEAF2_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_ENT-DC1-SPINE1_Ethernet1/1 | routed | - | 10.1.0.1/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_ENT-DC1-SPINE2_Ethernet1/1 | routed | - | 10.1.0.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description ENT-DC1-HOST1_Et1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_ENT-DC1-SPINE1_Ethernet1/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_ENT-DC1-SPINE2_Ethernet1/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet55/1
   description MLAG_PEER_ENT-DC1-LEAF2_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_ENT-DC1-LEAF2_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | ENT-DC1-HOST1_PortChannel101 | switched | trunk | 10,20,110,111 | - | - | - | - | 1 | - |
| Port-Channel551 | MLAG_PEER_ENT-DC1-LEAF2_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description ENT-DC1-HOST1_PortChannel101
   no shutdown
   switchport
...
interface Port-Channel551
   description MLAG_PEER_ENT-DC1-LEAF2_Po551
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.101.1/32 |
...
!
interface Vxlan1
   description ENT-DC1-LEAF1_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.1.0.0 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.1.0.2 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
| 10.255.251.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 10.1.101.1:10110 | 10110:10110 | - | - | learned |
| 111 | 10.1.101.1:10111 | 10111:10111 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.1.101.1:10 | connected |
...
router bgp 65101
   ...
   neighbor 10.255.251.1 description ENT-DC1-LEAF2
