...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.181/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC_COMPUTE_POD1 | Vlan4094 | 10.1.0.0 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | DC-HOST1_Et2 | *trunk | *10-14,20-22 | *- | *- | 3 |
| Ethernet55/1 | MLAG_PEER_DC-LEAF1_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_DC-LEAF1_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC-SPINE1_Ethernet2/1 | routed | - | 10.0.0.5/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC-SPINE2_Ethernet2/1 | routed | - | 10.0.0.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description DC-HOST1_Et2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_DC-SPINE1_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_DC-SPINE2_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet55/1
   description MLAG_PEER_DC-LEAF1_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_DC-LEAF1_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_PEER_DC-LEAF1_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_DC-LEAF1_Po551
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.254.2/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.255.1/32 |
| Loopback10 | Tenant_10_OP_Zone_VTEP_DIAGNOSTICS | Tenant_10_OP_Zone | 10.255.10.2/32 |
| Loopback11 | Tenant_10_WEB_Zone_VTEP_DIAGNOSTICS | Tenant_10_WEB_Zone | 10.255.11.2/32 |
| Loopback20 | Tenant_20_OP_Zone_VTEP_DIAGNOSTICS | Tenant_20_OP_Zone | 10.255.20.2/32 |
...
| Vlan3009 |  Tenant_10_OP_Zone  |  10.1.1.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Tenant_10_WEB_Zone  |  10.1.1.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Tenant_20_OP_Zone  |  10.1.1.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.1.1.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.1.0.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.1.1.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_10_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.1.1.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_10_WEB_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.1.1.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_20_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.254.2:10010 | 10010:10010 | - | - | learned |
| 11 | 10.255.254.2:10011 | 10011:10011 | - | - | learned |
| 12 | 10.255.254.2:10012 | 10012:10012 | - | - | learned |
| 13 | 10.255.254.2:10013 | 10013:10013 | - | - | learned |
| 14 | 10.255.254.2:10014 | 10014:10014 | - | - | learned |
| 20 | 10.255.254.2:10020 | 10020:10020 | - | - | learned |
| 21 | 10.255.254.2:10021 | 10021:10021 | - | - | learned |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC-LEAF1
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.0.0.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.4 remote-as 65000
   neighbor 10.0.0.4 description DC-SPINE1_Ethernet2/1
   neighbor 10.0.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.6 remote-as 65000
   neighbor 10.0.0.6 description DC-SPINE2_Ethernet2/1
   neighbor 10.1.1.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.1.1.0 description DC-LEAF1
   ...
   !
   vlan 10
      rd 10.255.254.2:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 11
      rd 10.255.254.2:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 10.255.254.2:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 13
      rd 10.255.254.2:10013
      route-target both 10013:10013
      redistribute learned
   !
   vlan 14
      rd 10.255.254.2:10014
      route-target both 10014:10014
      redistribute learned
   !
   vlan 20
      rd 10.255.254.2:10020
      route-target both 10020:10020
      redistribute learned
   !
   vlan 21
      rd 10.255.254.2:10021
...
| -------------- | --------------------- |
| Tenant_10_OP_Zone | 10.255.10.2 |
| Tenant_10_WEB_Zone | 10.255.11.2 |
| Tenant_20_OP_Zone | 10.255.20.2 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_10_OP_Zone address 10.255.10.2
ip address virtual source-nat vrf Tenant_10_WEB_Zone address 10.255.11.2
ip address virtual source-nat vrf Tenant_20_OP_Zone address 10.255.20.2
```
