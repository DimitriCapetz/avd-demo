...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.49/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| EnterpriseDC2LeafDomain1 | Vlan4094 | 10.255.255.1 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | ENT-DC2-HOST1_Et1 | *trunk | *10,20,210,211 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_ENT-DC2-LEAF2_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC2-LEAF2_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet1/1 | routed | - | 10.2.0.1/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet1/1 | routed | - | 10.2.0.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description ENT-DC2-HOST1_Et1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet1/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet1/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet55/1
   description MLAG_PEER_ENT-DC2-LEAF2_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_ENT-DC2-LEAF2_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_PEER_ENT-DC2-LEAF2_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_ENT-DC2-LEAF2_Po551
   no shutdown
   switchport
   switchport mode trunk
...
!
interface Vxlan1
   description ENT-DC2-LEAF1_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.2.0.0 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.2.0.2 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.255.252.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.2.101.1:10010 | 10010:10010 | - | - | learned |
| 20 | 10.2.101.1:10020 | 10020:10020 | - | - | learned |
| 30 | 10.2.101.1:10030 | 10030:10030 | - | - | learned |
| 210 | 10.2.101.1:10210 | 10210:10210 | - | - | learned |
| 211 | 10.2.101.1:10211 | 10211:10211 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.2.101.1:10 | connected |
...
router bgp 65201
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ENT-DC2-LEAF2
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.2.0.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.0 remote-as 65200
   neighbor 10.2.0.0 description ENT-DC2-SPINE1_Ethernet1/1
   neighbor 10.2.0.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.2 remote-as 65200
   neighbor 10.2.0.2 description ENT-DC2-SPINE2_Ethernet1/1
   ...
   neighbor 10.255.252.1 description ENT-DC2-LEAF2
