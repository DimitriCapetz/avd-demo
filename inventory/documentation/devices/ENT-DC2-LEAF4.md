...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.52/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| EnterpriseDC2LeafDomain2 | Vlan4094 | 10.255.255.4 | Port-Channel551 |
...
!
mlag configuration
   domain-id EnterpriseDC2LeafDomain2
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | ENT-DC2-HOST2_Et2 | *trunk | *10,20,210,212 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_ENT-DC2-LEAF3_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC2-LEAF3_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet4/1 | routed | - | 10.2.0.13/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet4/1 | routed | - | 10.2.0.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description ENT-DC2-HOST2_Et2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.2.0.13/31
!
interface Ethernet50/1
   description P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.2.0.15/31
!
interface Ethernet55/1
   description MLAG_PEER_ENT-DC2-LEAF3_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_ENT-DC2-LEAF3_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | ENT-DC2-HOST2_PortChannel1 | switched | trunk | 10,20,210,212 | - | - | - | - | 1 | - |
| Port-Channel551 | MLAG_PEER_ENT-DC2-LEAF3_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description ENT-DC2-HOST2_PortChannel1
   no shutdown
   switchport
   switchport trunk allowed vlan 10,20,210,212
...
interface Port-Channel551
   description MLAG_PEER_ENT-DC2-LEAF3_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.2.101.4/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.102.3/32 |
| Loopback10 | CORP_VTEP_DIAGNOSTICS | CORP | 10.255.20.4/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.2.101.4/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.2.102.3/32
!
...
| Vlan212 | CORP_DC2_RACK2 | CORP | - | False |
...
| Vlan212 |  CORP  |  -  |  10.212.212.1/24  |  -  |  -  |  -  |  -  |
| Vlan3009 |  CORP  |  10.255.252.5/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vlan212
   description CORP_DC2_RACK2
   no shutdown
   vrf CORP
   ip address virtual 10.212.212.1/24
!
interface Vlan3009
...
!
interface Vxlan1
   description ENT-DC2-LEAF4_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.2.0.12 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.2.0.14 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.255.252.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.2.101.4:10010 | 10010:10010 | - | - | learned |
| 20 | 10.2.101.4:10020 | 10020:10020 | - | - | learned |
| 30 | 10.2.101.4:10030 | 10030:10030 | - | - | learned |
| 210 | 10.2.101.4:10210 | 10210:10210 | - | - | learned |
| 212 | 10.2.101.4:10212 | 10212:10212 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.2.101.4:10 | connected |
...
router bgp 65202
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ENT-DC2-LEAF3
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.2.0.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.12 remote-as 65200
   neighbor 10.2.0.12 description ENT-DC2-SPINE1_Ethernet4/1
   neighbor 10.2.0.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.14 remote-as 65200
   neighbor 10.2.0.14 description ENT-DC2-SPINE2_Ethernet4/1
   ...
   neighbor 10.255.252.4 description ENT-DC2-LEAF3
...
```eos
!
ip address virtual source-nat vrf CORP address 10.255.20.4
```
