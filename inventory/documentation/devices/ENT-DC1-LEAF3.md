...
| --------- | --------------- | ------------ | --------- |
| EnterpriseDC1LeafDomain2 | Vlan4094 | 10.255.255.5 | Port-Channel551 |
...
| Ethernet55/1 | MLAG_PEER_ENT-DC1-LEAF4_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC1-LEAF4_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| Port-Channel551 | MLAG_PEER_ENT-DC1-LEAF4_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.1.0.8 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.1.0.10 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65102
   ...
   neighbor 10.1.0.8 remote-as 65100
