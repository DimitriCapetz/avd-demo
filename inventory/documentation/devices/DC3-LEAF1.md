...
| --------- | --------------- | ------------ | --------- |
| DC3_LEAF_DOMAIN_1 | Vlan4094 | 10.255.255.1 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC3-HOST1_Et1 | *access | *10 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_DC3-LEAF2_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_DC3-LEAF2_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC3-SPINE1_Ethernet1/1 | routed | - | 10.3.0.1/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC3-SPINE2_Ethernet1/1 | routed | - | 10.3.0.3/31 | default | 1500 | False | - | - |
...
| Port-Channel551 | MLAG_PEER_DC3-LEAF2_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.3.0.0 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.3.0.2 | 65003 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
router bgp 65301
   ...
   neighbor 10.3.0.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.3.0.0 remote-as 65003
   neighbor 10.3.0.0 description DC3-SPINE1_Ethernet1/1
   neighbor 10.3.0.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.3.0.2 remote-as 65003
   neighbor 10.3.0.2 description DC3-SPINE2_Ethernet1/1
   ...
   neighbor 10.255.254.1 description DC3-LEAF2
