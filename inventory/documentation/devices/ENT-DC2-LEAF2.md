...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.50/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| EnterpriseDC2LeafDomain1 | Vlan4094 | 10.255.255.0 | Port-Channel551 |
...
!
mlag configuration
   domain-id EnterpriseDC2LeafDomain1
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | ENT-DC2-HOST1_Et2 | *trunk | *10,20,210,211 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_ENT-DC2-LEAF1_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC2-LEAF1_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet2/1 | routed | - | 10.2.0.5/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet2/1 | routed | - | 10.2.0.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description ENT-DC2-HOST1_Et2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet55/1
   description MLAG_PEER_ENT-DC2-LEAF1_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_ENT-DC2-LEAF1_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | ENT-DC2-HOST1_PortChannel1 | switched | trunk | 10,20,210,211 | - | - | - | - | 1 | - |
| Port-Channel551 | MLAG_PEER_ENT-DC2-LEAF1_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description ENT-DC2-HOST1_PortChannel1
   no shutdown
   switchport
   switchport trunk allowed vlan 10,20,210,211
...
interface Port-Channel551
   description MLAG_PEER_ENT-DC2-LEAF1_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.2.101.2/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.102.1/32 |
| Loopback10 | CORP_VTEP_DIAGNOSTICS | CORP | 10.255.20.2/32 |
...
| Vlan211 | CORP_DC2_RACK1 | CORP | - | False |
...
| Vlan211 |  CORP  |  -  |  10.211.211.1/24  |  -  |  -  |  -  |  -  |
| Vlan3009 |  CORP  |  10.255.252.1/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vlan211
   description CORP_DC2_RACK1
   no shutdown
   vrf CORP
   ip address virtual 10.211.211.1/24
!
interface Vlan3009
...
!
interface Vxlan1
   description ENT-DC2-LEAF2_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.2.0.4 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.2.0.6 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.255.252.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.2.101.2:10010 | 10010:10010 | - | - | learned |
| 20 | 10.2.101.2:10020 | 10020:10020 | - | - | learned |
| 30 | 10.2.101.2:10030 | 10030:10030 | - | - | learned |
| 210 | 10.2.101.2:10210 | 10210:10210 | - | - | learned |
| 211 | 10.2.101.2:10211 | 10211:10211 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.2.101.2:10 | connected |
...
router bgp 65201
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ENT-DC2-LEAF1
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.2.0.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.4 remote-as 65200
   neighbor 10.2.0.4 description ENT-DC2-SPINE1_Ethernet2/1
   neighbor 10.2.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.6 remote-as 65200
   neighbor 10.2.0.6 description ENT-DC2-SPINE2_Ethernet2/1
   ...
   neighbor 10.255.252.0 description ENT-DC2-LEAF1
...
```eos
!
ip address virtual source-nat vrf CORP address 10.255.20.2
```
