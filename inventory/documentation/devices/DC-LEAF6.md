...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.185/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC_COMPUTE_POD3 | Vlan4094 | 10.1.0.8 | Port-Channel551 |
...
!
mlag configuration
   domain-id DC_COMPUTE_POD3
   local-interface Vlan4094
   peer-address 10.1.0.8
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | MLAG_PEER_DC-LEAF5_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_DC-LEAF5_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC-SPINE1_Ethernet6/1 | routed | - | 10.0.0.21/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC-SPINE2_Ethernet6/1 | routed | - | 10.0.0.23/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_LINK_TO_DC-SPINE1_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_DC-SPINE2_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet55/1
   description MLAG_PEER_DC-LEAF5_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_DC-LEAF5_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel551 | MLAG_PEER_DC-LEAF5_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_DC-LEAF5_Po551
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.254.6/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.255.5/32 |
| Loopback10 | Tenant_10_OP_Zone_VTEP_DIAGNOSTICS | Tenant_10_OP_Zone | 10.255.10.6/32 |
| Loopback11 | Tenant_10_WEB_Zone_VTEP_DIAGNOSTICS | Tenant_10_WEB_Zone | 10.255.11.6/32 |
| Loopback20 | Tenant_20_OP_Zone_VTEP_DIAGNOSTICS | Tenant_20_OP_Zone | 10.255.20.6/32 |
...
| Vlan15 | Tenant_10_WEB_Zone_3 | Tenant_10_WEB_Zone | - | False |
...
| Vlan15 |  Tenant_10_WEB_Zone  |  -  |  10.10.15.1/24  |  -  |  -  |  -  |  -  |
| Vlan20 |  Tenant_20_OP_Zone  |  -  |  10.20.20.0/24  |  -  |  -  |  -  |  -  |
| Vlan21 |  Tenant_20_OP_Zone  |  -  |  10.20.21.1/24  |  -  |  -  |  -  |  -  |
| Vlan3009 |  Tenant_10_OP_Zone  |  10.1.1.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Tenant_10_WEB_Zone  |  10.1.1.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Tenant_20_OP_Zone  |  10.1.1.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.1.1.9/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.1.0.9/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vlan15
   description Tenant_10_WEB_Zone_3
   no shutdown
   vrf Tenant_10_WEB_Zone
   ip address virtual 10.10.15.1/24
!
interface Vlan20
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.0.0.20 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.0.0.22 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.1.1.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| 10.1.1.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_10_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.1.1.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_10_WEB_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
| 10.1.1.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_20_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.254.6:10010 | 10010:10010 | - | - | learned |
| 11 | 10.255.254.6:10011 | 10011:10011 | - | - | learned |
| 12 | 10.255.254.6:10012 | 10012:10012 | - | - | learned |
| 13 | 10.255.254.6:10013 | 10013:10013 | - | - | learned |
| 14 | 10.255.254.6:10014 | 10014:10014 | - | - | learned |
| 15 | 10.255.254.6:10015 | 10015:10015 | - | - | learned |
| 20 | 10.255.254.6:10020 | 10020:10020 | - | - | learned |
| 21 | 10.255.254.6:10021 | 10021:10021 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_10_OP_Zone | 10.255.254.6:10 | connected |
| Tenant_10_WEB_Zone | 10.255.254.6:11 | connected |
| Tenant_20_OP_Zone | 10.255.254.6:20 | connected |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description DC-LEAF5
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.0.0.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.20 remote-as 65000
   neighbor 10.0.0.20 description DC-SPINE1_Ethernet6/1
   neighbor 10.0.0.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.22 remote-as 65000
   neighbor 10.0.0.22 description DC-SPINE2_Ethernet6/1
   neighbor 10.1.1.8 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.1.1.8 description DC-LEAF5
   ...
   !
   vlan 10
      rd 10.255.254.6:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 11
      rd 10.255.254.6:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 10.255.254.6:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 13
      rd 10.255.254.6:10013
      route-target both 10013:10013
      redistribute learned
   !
   vlan 14
      rd 10.255.254.6:10014
      route-target both 10014:10014
      redistribute learned
   !
   vlan 15
      rd 10.255.254.6:10015
      route-target both 10015:10015
      redistribute learned
   !
   vlan 20
      rd 10.255.254.6:10020
      route-target both 10020:10020
      redistribute learned
   !
   vlan 21
      rd 10.255.254.6:10021
...
| -------------- | --------------------- |
| Tenant_10_OP_Zone | 10.255.10.6 |
| Tenant_10_WEB_Zone | 10.255.11.6 |
| Tenant_20_OP_Zone | 10.255.20.6 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_10_OP_Zone address 10.255.10.6
ip address virtual source-nat vrf Tenant_10_WEB_Zone address 10.255.11.6
ip address virtual source-nat vrf Tenant_20_OP_Zone address 10.255.20.6
```
