...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.179/24 | 10.99.99.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_DC-LEAF1_Ethernet50/1 | routed | - | 10.0.0.2/31 | default | 1500 | False | - | - |
| Ethernet2/1 | P2P_LINK_TO_DC-LEAF2_Ethernet50/1 | routed | - | 10.0.0.6/31 | default | 1500 | False | - | - |
| Ethernet3/1 | P2P_LINK_TO_DC-LEAF3_Ethernet50/1 | routed | - | 10.0.0.10/31 | default | 1500 | False | - | - |
| Ethernet4/1 | P2P_LINK_TO_DC-LEAF4_Ethernet50/1 | routed | - | 10.0.0.14/31 | default | 1500 | False | - | - |
| Ethernet7/1 | P2P_LINK_TO_DC-BORDER1_Ethernet50/1 | routed | - | 10.0.1.250/31 | default | 1500 | False | - | - |
| Ethernet8/1 | P2P_LINK_TO_DC-BORDER2_Ethernet50/1 | routed | - | 10.0.1.254/31 | default | 1500 | False | - | - |
...
interface Ethernet1/1
   description P2P_LINK_TO_DC-LEAF1_Ethernet50/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet2/1
   description P2P_LINK_TO_DC-LEAF2_Ethernet50/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet3/1
   description P2P_LINK_TO_DC-LEAF3_Ethernet50/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet4/1
   description P2P_LINK_TO_DC-LEAF4_Ethernet50/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet7/1
   description P2P_LINK_TO_DC-BORDER1_Ethernet50/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet8/1
   description P2P_LINK_TO_DC-BORDER2_Ethernet50/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.252.2/32 |
...
| 10.0.1.251 | 65199 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.0.1.255 | 65199 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 10.0.0.3 description DC-LEAF1_Ethernet50/1
   neighbor 10.0.0.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.7 remote-as 65101
   neighbor 10.0.0.7 description DC-LEAF2_Ethernet50/1
   neighbor 10.0.0.11 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.11 remote-as 65102
   neighbor 10.0.0.11 description DC-LEAF3_Ethernet50/1
   neighbor 10.0.0.15 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.0.15 remote-as 65102
   neighbor 10.0.0.15 description DC-LEAF4_Ethernet50/1
   neighbor 10.0.1.251 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.1.251 remote-as 65199
   neighbor 10.0.1.251 description DC-BORDER1_Ethernet50/1
   neighbor 10.0.1.255 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.1.255 remote-as 65199
   neighbor 10.0.1.255 description DC-BORDER2_Ethernet50/1
