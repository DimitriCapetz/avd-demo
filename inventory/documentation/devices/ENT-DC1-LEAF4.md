...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.46/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF_DOMAIN_2 | Vlan4094 | 10.255.255.4 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | ENT-DC1-HOST2_Et2 | *trunk | *10,20,110,112 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_ENT-DC1-LEAF3_Ethernet55/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC1-LEAF3_Ethernet56/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_ENT-DC1-SPINE1_Ethernet4/1 | routed | - | 10.1.0.13/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_ENT-DC1-SPINE2_Ethernet4/1 | routed | - | 10.1.0.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description ENT-DC1-HOST2_Et2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_ENT-DC1-SPINE1_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_ENT-DC1-SPINE2_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet55/1
   description MLAG_PEER_ENT-DC1-LEAF3_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_ENT-DC1-LEAF3_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | ENT-DC1-HOST2_PortChannel101 | switched | trunk | 10,20,110,112 | - | - | - | - | 1 | - |
| Port-Channel551 | MLAG_PEER_ENT-DC1-LEAF3_Po551 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description ENT-DC1-HOST2_PortChannel101
   no shutdown
   switchport
   switchport trunk allowed vlan 10,20,110,112
...
interface Port-Channel551
   description MLAG_PEER_ENT-DC1-LEAF3_Po551
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.101.4/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.102.3/32 |
...
interface Vlan112
   ...
   no shutdown
   vrf CORP
   ip address virtual 10.112.112.1/24
!
interface Vlan3009
...
!
interface Vxlan1
   description ENT-DC1-LEAF4_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- |
| 10.1.0.12 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.1.0.14 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - |
| 10.1.100.1 | 65001 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - |
| 10.1.100.2 | 65001 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - |
...
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 10.1.101.4:10110 | 10110:10110 | - | - | learned |
| 112 | 10.1.101.4:10112 | 10112:10112 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.1.101.4:10 | connected |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ENT-DC1-LEAF3
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.1.0.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.1.0.12 remote-as 65001
   neighbor 10.1.0.12 description ENT-DC1-SPINE1_Ethernet4/1
   neighbor 10.1.0.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.1.0.14 remote-as 65001
   neighbor 10.1.0.14 description ENT-DC1-SPINE2_Ethernet4/1
   ...
   neighbor 10.1.100.2 remote-as 65001
   neighbor 10.1.100.2 description ENT-DC1-SPINE2
   neighbor 10.255.251.4 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.251.4 description ENT-DC1-LEAF3
