...
| --------- | --------------- | ------------ | --------- |
| EnterpriseDC1LeafDomain2 | Vlan4094 | 10.255.255.4 | Port-Channel551 |
...
!
mlag configuration
   domain-id EnterpriseDC1LeafDomain2
...
| Ethernet55/1 | MLAG_PEER_ENT-DC1-LEAF3_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC1-LEAF3_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | ENT-DC1-HOST2_PortChannel1 | switched | trunk | 10,20,110,112 | - | - | - | - | 1 | - |
| Port-Channel551 | MLAG_PEER_ENT-DC1-LEAF3_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.1.0.12 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.1.0.14 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.1.101.4:10010 | 10010:10010 | - | - | learned |
| 20 | 10.1.101.4:10020 | 10020:10020 | - | - | learned |
| 30 | 10.1.101.4:10030 | 10030:10030 | - | - | learned |
...
router bgp 65102
   ...
   neighbor 10.1.0.12 remote-as 65100
