...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.53/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| EnterpriseDC2LeafDomain3 | Vlan4094 | 10.255.255.9 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | ENT-DC2-HOST3_Et1 | *trunk | *10,20,210,213 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_ENT-DC2-LEAF6_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC2-LEAF6_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet5/1 | routed | - | 10.2.0.17/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet5/1 | routed | - | 10.2.0.19/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description ENT-DC2-HOST3_Et1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet5/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet5/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.2.0.19/31
!
interface Ethernet55/1
   description MLAG_PEER_ENT-DC2-LEAF6_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_ENT-DC2-LEAF6_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_PEER_ENT-DC2-LEAF6_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_ENT-DC2-LEAF6_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.2.101.5/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.102.5/32 |
| Loopback10 | CORP_VTEP_DIAGNOSTICS | CORP | 10.255.20.5/32 |
...
!
interface Vxlan1
   description ENT-DC2-LEAF5_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.2.0.16 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.2.0.18 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.255.252.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.2.101.5:10010 | 10010:10010 | - | - | learned |
| 20 | 10.2.101.5:10020 | 10020:10020 | - | - | learned |
| 30 | 10.2.101.5:10030 | 10030:10030 | - | - | learned |
| 210 | 10.2.101.5:10210 | 10210:10210 | - | - | learned |
| 213 | 10.2.101.5:10213 | 10213:10213 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.2.101.5:10 | connected |
...
router bgp 65203
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ENT-DC2-LEAF6
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.2.0.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.16 remote-as 65200
   neighbor 10.2.0.16 description ENT-DC2-SPINE1_Ethernet5/1
   neighbor 10.2.0.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.18 remote-as 65200
   neighbor 10.2.0.18 description ENT-DC2-SPINE2_Ethernet5/1
   ...
   neighbor 10.255.252.9 description ENT-DC2-LEAF6
...
```eos
!
ip address virtual source-nat vrf CORP address 10.255.20.5
```
