...
| --------- | --------------- | ------------ | --------- |
| ENT-DC2-LEAF-DOMAIN-3 | Vlan4094 | 10.255.255.9 | Port-Channel551 |
...
!
mlag configuration
   domain-id ENT-DC2-LEAF-DOMAIN-3
...
| Loopback10 | CORP_VTEP_DIAGNOSTICS | CORP | 10.255.10.5/32 |
...
```eos
!
ip address virtual source-nat vrf CORP address 10.255.10.5
```
