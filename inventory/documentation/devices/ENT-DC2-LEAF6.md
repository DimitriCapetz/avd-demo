...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | management | 10.99.99.54/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| EnterpriseDC2LeafDomain3 | Vlan4094 | 10.255.255.8 | Port-Channel551 |
...
!
mlag configuration
   domain-id EnterpriseDC2LeafDomain3
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | ENT-DC2-HOST3_Et2 | *trunk | *10,20,210,213 | *- | *- | 1 |
| Ethernet55/1 | MLAG_PEER_ENT-DC2-LEAF5_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_ENT-DC2-LEAF5_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet6/1 | routed | - | 10.2.0.21/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet6/1 | routed | - | 10.2.0.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description ENT-DC2-HOST3_Et2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_ENT-DC2-SPINE1_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.2.0.21/31
!
interface Ethernet50/1
   description P2P_LINK_TO_ENT-DC2-SPINE2_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.2.0.23/31
!
interface Ethernet55/1
   description MLAG_PEER_ENT-DC2-LEAF5_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_ENT-DC2-LEAF5_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | ENT-DC2-HOST3_PortChannel1 | switched | trunk | 10,20,210,213 | - | - | - | - | 1 | - |
| Port-Channel551 | MLAG_PEER_ENT-DC2-LEAF5_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description ENT-DC2-HOST3_PortChannel1
   no shutdown
   switchport
   switchport trunk allowed vlan 10,20,210,213
...
interface Port-Channel551
   description MLAG_PEER_ENT-DC2-LEAF5_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.2.101.6/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.102.5/32 |
| Loopback10 | CORP_VTEP_DIAGNOSTICS | CORP | 10.255.20.6/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.2.101.6/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.2.102.5/32
!
...
| Vlan210 | CORP_DC2_SHARED | CORP | - | False |
| Vlan213 | CORP_DC2_RACK3 | CORP | - | False |
...
| Vlan210 |  CORP  |  -  |  10.210.210.1/24  |  -  |  -  |  -  |  -  |
| Vlan213 |  CORP  |  -  |  10.213.213.1/24  |  -  |  -  |  -  |  -  |
| Vlan3009 |  CORP  |  10.255.252.9/31  |  -  |  -  |  -  |  -  |  -  |
...
!
interface Vlan210
   description CORP_DC2_SHARED
   no shutdown
   vrf CORP
   ip address virtual 10.210.210.1/24
!
interface Vlan213
   description CORP_DC2_RACK3
   no shutdown
   vrf CORP
   ip address virtual 10.213.213.1/24
!
interface Vlan3009
...
!
interface Vxlan1
   description ENT-DC2-LEAF6_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.2.0.20 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.2.0.22 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.255.252.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CORP | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.2.101.6:10010 | 10010:10010 | - | - | learned |
| 20 | 10.2.101.6:10020 | 10020:10020 | - | - | learned |
| 30 | 10.2.101.6:10030 | 10030:10030 | - | - | learned |
| 210 | 10.2.101.6:10210 | 10210:10210 | - | - | learned |
| 213 | 10.2.101.6:10213 | 10213:10213 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CORP | 10.2.101.6:10 | connected |
...
router bgp 65203
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description ENT-DC2-LEAF5
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor 10.2.0.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.20 remote-as 65200
   neighbor 10.2.0.20 description ENT-DC2-SPINE1_Ethernet6/1
   neighbor 10.2.0.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.22 remote-as 65200
   neighbor 10.2.0.22 description ENT-DC2-SPINE2_Ethernet6/1
   ...
   neighbor 10.255.252.8 description ENT-DC2-LEAF5
...
```eos
!
ip address virtual source-nat vrf CORP address 10.255.20.6
```
